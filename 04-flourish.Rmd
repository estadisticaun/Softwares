...
```{r pestañadatosflourish-fig, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Pestaña de datos', out.width='85%'}
...
```{r pestañadatossubirdatosflourish-fig, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Subir archivo de datos', out.width='40%'}
