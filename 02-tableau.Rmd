...
```{r columaciunac-fig, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Problema columna CiuNac', out.width='80%'}
...
```{r descripcion-fig, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Descripción columna DepNac', out.width='80%'}
