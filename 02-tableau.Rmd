...
```
4.	En el panel tablas se crea un nuevo campo que contiene las agrupaciones, arrastre el campo Edad Mod al estante filas, arrastre Agrupaciones para edad a columnas, en el menú desplegable del campo que ubico en filas seleccione medida y recuento; y para el campo en columnas seleccione continuo, su histograma debe verse así.

```{r paso4histograma-fig, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Histograma con un valor nulo', out.width='80%'}
knitr::include_graphics("Imágenes/analisis92.jpg")
```

5.	Haga clic en 1 nulo que aparece en la esquina inferior derecha y seleccione filtrar datos, para que la vista no tenga en cuenta el valor nulo que contiene la base de datos.

6.	Haga clic derecho en el eje x y seleccione editar eje, en titulo escriba Edad; en la pestaña Marcas de graduación seleccione fijo, origen de graduación cero e intervalo de graduación cinco para marcas de graduación principal.

```{r paso6histograma-fig, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Editar eje x de agrupaciones', out.width='40%'}
knitr::include_graphics("Imágenes/analisis93.jpg")
```

7.	Cambie el titulo del eje y por Número de graduados y edite la descripción emergente. 
