...
knitr::include_graphics("Imágenes/compartir5.jpg")
```
...
10.	Debe ocultar los tirulos de las hojas puestas sobre el contendor, haga clic sobre el titulo de la serie, seleccione mas opciones y luego título, esto debe hacerlo también para la hoja tabla.
...
13.	Cambie el nombre del dashboard a modalidad de formación, recuerde que los filtros de semestre y año únicamente aplican cuando el parámetro seleccione visualización se encuentra en tabla. 

A continuación, se presenta el dashboard obtenido que proporciona información clara sobre la modalidad de formación y permite intercambiar entre la serie y la tabla de texto.
...
```{r paso2compartir-fig, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Crear una historia', out.width='80%'}
knitr::include_graphics("Imágenes/compartir16.jpg")
```

3.	En el cuadro gris añada como subtitulo Evolución graduados, en el panel lateral izquierdo en la pestaña historia encontrar un botón que tiene el texto En blanco, dicho botón es usado para crear mas puntos en la historia, haga clic allí hasta tener $8$ puntos en la historia. Añada estos subtítulos a los puntos de la historia en este orden Modalidad de formación, Nivel de formación, Sede de admisión, Nacionalidad, Lugar de nacimiento, Sexo, Áreas del conocimiento.

4.	En el primer punto de la historia agrega la hoja llamada Evolución histórica del total de estudiantes graduados.
...
5.	Observe que al agregar hojas a una historia estas se agregan sin el título, para agregar un título o una descripción de la visualización que se esta presentando, en el panel lateral derecho se ubica una opción llamada Arrastrar a añadir texto, arrástrela hacia la visualización y en el cuadro de dialogo escriba evolución histórica del total de estudiantes graduados, como fuente seleccione Tableau Light, tamaño 18, negrilla y centrada.

```{r paso5compartir-fig, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Añadir texto', out.width='80%'}
knitr::include_graphics("Imágenes/compartir18.jpg")
```
6.	A los demás puntos de las historias añada los tableros que fueron creados en la sección anterior. 

7.	Haga clic en la pestaña formato ubicada sobre la barra de herramientas y seleccione historia. 

```{r paso7compartir-fig, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Formato de la historia', out.width='20%'}
...
9.	Finalmente, en objetos de texto seleccione ninguno para el sombreado y para el borde.
