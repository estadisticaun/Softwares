...
\caption{Problema columna CiuNac}\label{fig:columaciunac-fig}
\end{figure}
...
\caption{Descripción columna DepNac}\label{fig:descripcion-fig}
\end{figure}
...
\caption{Agrupamiento de la columna Edad_Mod}\label{fig:gruposedad-fig}
\end{figure}
