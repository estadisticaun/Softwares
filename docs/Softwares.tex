...
{\centering \includegraphics[width=0.8\linewidth]{Imágenes/compartir5} 
...
\tightlist
\item
  Debe ocultar los tirulos de las hojas puestas sobre el contendor, haga clic sobre el titulo de la serie, seleccione mas opciones y luego título, esto debe hacerlo también para la hoja tabla.
\end{enumerate}
...
{\centering \includegraphics[width=0.8\linewidth]{Imágenes/compartir8} 
...
\item
  Cambie el nombre del dashboard a modalidad de formación, recuerde que los filtros de semestre y año únicamente aplican cuando el parámetro seleccione visualización se encuentra en tabla.
\end{enumerate}
...
{\centering \includegraphics[width=0.8\linewidth]{Imágenes/compartir9} 
...
{\centering \includegraphics[width=0.8\linewidth]{Imágenes/compartir11} 
...
{\centering \includegraphics[width=0.8\linewidth]{Imágenes/compartir12} 
...
{\centering \includegraphics[width=0.8\linewidth]{Imágenes/compartir13} 
...
\caption{Crear una historia}\label{fig:paso2compartir-fig}
\end{figure}
...
\item
  En el primer punto de la historia agrega la hoja llamada Evolución histórica del total de estudiantes graduados.
\end{enumerate}
...
\caption{Añadir texto}\label{fig:paso5compartir-fig}
\end{figure}
...
{\centering \includegraphics[width=0.2\linewidth]{Imágenes/compartir19} 

}

\caption{Formato de la historia}\label{fig:paso7compartir-fig}
\end{figure}
...
\item
  Finalmente, en objetos de texto seleccione ninguno para el sombreado y para el borde.
\end{enumerate}
...
{\centering \includegraphics[width=0.6\linewidth]{Imágenes/compartir21} 
