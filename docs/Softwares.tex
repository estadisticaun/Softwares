...
\hypertarget{gruxe1fico-de-bala}{%
\subsubsection{Gráfico de bala}\label{gruxe1fico-de-bala}}
...
\tightlist
\item
  En el panel tablas se crea un nuevo campo que contiene las agrupaciones, arrastre el campo Edad Mod al estante filas, arrastre Agrupaciones para edad a columnas, en el menú desplegable del campo que ubico en filas seleccione medida y recuento; y para el campo en columnas seleccione continuo, su histograma debe verse así.
\end{enumerate}

\begin{figure}

{\centering \includegraphics[width=0.8\linewidth]{Imágenes/analisis92} 

}

\caption{Histograma con un valor nulo}\label{fig:paso4histograma-fig}
\end{figure}
...
\setcounter{enumi}{4}
\item
  Haga clic en 1 nulo que aparece en la esquina inferior derecha y seleccione filtrar datos, para que la vista no tenga en cuenta el valor nulo que contiene la base de datos.
\item
...
{\centering \includegraphics[width=0.4\linewidth]{Imágenes/analisis93} 

}

\caption{Editar eje x de agrupaciones}\label{fig:paso6histograma-fig}
\end{figure}
...
{\centering \includegraphics[width=0.8\linewidth]{Imágenes/analisis94} 
