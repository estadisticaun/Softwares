...
\tightlist
\item
  Tableau permite añadir líneas de tendencia que representarían modelos de regresión lineal simple, desde el panel análisis en personalizado arrastre línea de tendencia y suéltela en lineal, observe que Tableau proporciona mas opciones tales como logarítmica, exponencial, polinómica y potencia.
\end{enumerate}
