...
```{r columnacondicional-fig, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Crear columna condicional', out.width='20%'}
...
```{r combinardatos-fig, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Combinar tablas de datos', out.width='40%'}
...
```{r anexardatos-fig, echo=FALSE, fig.align='center', fig.asp=.75, fig.cap='Anexar datos', out.width='40%'}
